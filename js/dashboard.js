...
function actualizarDashboard() {
    ...
    if (casillasActivas.length === 0) {
        ...
        casillasActivas.forEach((casilla, i) => {
            ...
            // Obtener usuarios asignados a la casilla
            const usuariosAsignados = db.obtenerUsuariosCasilla(casilla.id);
            const usuariosTexto = usuariosAsignados.length > 0 
            ...
            <div class="module ${i < 4 ? 'module-left-height' : 'module-right-height'}${isBusy ? ' active' : ''}">
                ...
                <div class='datos-casilla'>
                    <span><span class='dato-label'>Usuarios:</span> ${usuariosTexto}</span>
